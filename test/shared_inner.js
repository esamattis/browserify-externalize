    ...
    externalize(parentBundle, externalBundle, function(err) {
        ...
        parentBundle.bundle(function(err, parentSrc) {
            ...
            externalBundle.bundle(function(err, extSrc) {
                ...
                t.ok(parentSrc.toString('utf8').match(/INNER DEP/), "inner dep code must be in parent src");
                t.notOk(extSrc.toString('utf8').match(/INNER DEP/), "inner dep code must not be in external bundle");
